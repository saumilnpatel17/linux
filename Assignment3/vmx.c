...
extern atomic_t cmpe283_assign3_atm_individual_exit_count_array[69];
...
static int vmx_handle_exit(struct kvm_vcpu *vcpu, fastpath_t exit_fastpath)
{
	...
	//CMPE283 Assignment 3 code changes
	if(kvm_vmx_exit_handlers[exit_reason] && (exit_reason < kvm_vmx_max_exit_handlers)){
		atomic_inc(&cmpe283_assign3_atm_individual_exit_count_array[exit_reason]);
	} else {
		atomic_set(&cmpe283_assign3_atm_individual_exit_count_array[exit_reason], 0xffffffff);
	}
